...
public class Dragonfly : MonoBehaviour
{
    ...
    public void SetLocalPosition(Vector3 newPosition)
    {
        ...
        if (currentOffsetV3 == northV3)
        {
            myAnimator.SetBool("movingHorizontal", false);
            myAnimator.SetBool("movingVertical", true);
            mySpriteRenderer.flipY = false;
        }

        else if (currentOffsetV3 == southV3)
        {
            myAnimator.SetBool("movingHorizontal", false);
            myAnimator.SetBool("movingVertical", true);
        ...
        else if (currentOffsetV3 == eastV3)
        {
            myAnimator.SetBool("movingVertical", false);
            myAnimator.SetBool("movingHorizontal", true);
            mySpriteRenderer.flipX = false;
        }

        else if (currentOffsetV3 == westV3)
        {
            myAnimator.SetBool("movingVertical", false);
            myAnimator.SetBool("movingHorizontal", true);
